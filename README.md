...
### Biological Concepts
- **Watson-Crick Base Pairing:** Watson, J.D. and Crick, F.H.C. (1953). "Molecular Structure of Nucleic Acids"
- **FASTA Format:** Pearson, W.R. and Lipman, D.J. (1988). "Improved tools for biological sequence comparison"
- **GC Content Analysis:** Relevant for understanding genomic structure and function
...
### Course Materials
- INFO-B 473/B573 Course Notes
- Assignment 1: Initial sequence download and setup
- Git Repository Best Practices Guide
...
**Student:** Venkatesh Joshi  
**Course:** INFO-B 473/B573  
**Instructor:** [Instructor Name]  
**Semester:** Fall 2025

For questions, issues, or clarifications regarding this assignment:
...
- Course instructors for assignment design and guidance
- R Core Team for the R programming language
- NCBI for providing public genomic data
- Classmates for collaborative learning and support

---

## License and Academic Integrity

This project is submitted as coursework for INFO-B 473/B573. All work is original and completed in accordance with the university's academic integrity policies.

**Academic Integrity Statement:**
I certify that this assignment represents my own work and that I have neither given nor received unauthorized assistance. All code, analysis, and documentation were created by me specifically for this assignment.
